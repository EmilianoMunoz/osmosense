...
from backend.app.core.region import filtrar_gdf_san_rafael, limite_san_rafael_existe
from backend.scripts.experiments.recalcular_dataset_desde_ide import normalizar_cultivo


INPUT_PARCELAS = "backend/data/parcelas/parcelas_ide.geojson"
OUTPUT_COMPLETO = "backend/data/parcelas/san_rafael_completo_wgs84.geojson"
OUTPUT_VID_OLIVO = "backend/data/parcelas/san_rafael_vid_olivo_wgs84.geojson"
