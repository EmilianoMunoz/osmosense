...
OUTPUT_TEMPORAL = "backend/data/dataset_temporal_hidrico.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input", default="backend/data/parcelas/parcelas_ide.geojson")
    parser.add_argument(
        "--parcel-source",
    ...
    parser.add_argument("--output-sample", default="backend/data/parcelas/muestra_recalculada.geojson")
