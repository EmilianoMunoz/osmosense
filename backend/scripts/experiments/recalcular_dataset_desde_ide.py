...
from backend.app.core.region import SAN_RAFAEL_BOUNDS, filtrar_gdf_san_rafael
...
INPUT_GEOJSON = "backend/data/parcelas/parcelas_ide.geojson"
OUTPUT_SAMPLE = "backend/data/parcelas/muestra_recalculada.geojson"
OUTPUT_MONTHLY = "backend/data/dataset_mensual_recalculado.csv"
OUTPUT_WIDE = "backend/data/dataset_fenologico_recalculado.csv"
