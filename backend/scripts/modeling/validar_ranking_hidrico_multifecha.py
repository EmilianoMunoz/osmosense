...
from backend.scripts.modeling.validar_ranking_hidrico import validar


INPUT_TEMPORAL = "backend/data/dataset_temporal_hidrico.csv"
MODEL_DIR = "backend/models/hidrico_regresion"
OUTPUT_DETAIL = "backend/data/validacion_ranking_hidrico_multifecha.csv"
OUTPUT_SUMMARY = "backend/data/validacion_ranking_hidrico_multifecha_resumen.csv"
