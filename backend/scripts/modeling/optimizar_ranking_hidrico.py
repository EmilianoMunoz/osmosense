...
INPUT_DETAIL = "backend/data/validacion_ranking_hidrico_multifecha_2024.csv"
OUTPUT_CONFIG = "backend/models/ranking_hidrico_config.json"
OUTPUT_RESULTS = "backend/data/optimizacion_ranking_hidrico.csv"
SCORE_COLUMNS = [
    "riesgo_pred_10d",
    "riesgo_pred_5d",
    "delta_10d_pos",
