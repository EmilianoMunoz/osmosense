...
DEFAULT_INPUT = ROOT / "backend/data/zonificacion/regional_dgi.csv"
DEFAULT_LIMIT = ROOT / "backend/data/limites/san_rafael.geojson"
DEFAULT_OUTPUT = ROOT / "backend/data/zonificacion/regional_dgi_san_rafael.geojson"
DEFAULT_SUMMARY = ROOT / "backend/data/zonificacion/regional_dgi_san_rafael_resumen.csv"
