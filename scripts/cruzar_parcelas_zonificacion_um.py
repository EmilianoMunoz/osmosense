...
DEFAULT_ZONIFICACION = Path("data/zonificacion/regional_dgi_san_rafael.geojson")
DEFAULT_PARCELAS = Path("data/parcelas/san_rafael_vid_olivo_wgs84.geojson")
DEFAULT_RANKING = Path("data/rankings/ranking_hidrico_latest.csv")
DEFAULT_OUT_DIR = Path("data/zonificacion")
