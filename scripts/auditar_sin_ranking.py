...
from scripts.recalcular_dataset_desde_ide import AREA_MINIMA_M2


AUDITORIA_COBERTURA = "data/auditoria_cobertura_parcelas.csv"
PARCELAS_OFICIALES = "data/parcelas/san_rafael_vid_olivo_wgs84.geojson"
MUESTRA_TEMPORAL = "data/parcelas/muestra_temporal_full_vid_olivo.geojson"
DATASET_TEMPORAL = "data/dataset_temporal_hidrico.csv"
OUTPUT_DETALLE = "data/auditoria_sin_ranking_detalle.csv"
OUTPUT_RESUMEN = "data/auditoria_sin_ranking_resumen.csv"
OUTPUT_GEOJSON = "data/auditoria_sin_ranking_detalle.geojson"
