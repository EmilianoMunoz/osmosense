...
from scripts.generar_targets_hidricos_regresion import preparar_observaciones


INPUT_TEMPORAL = "data/dataset_temporal_hidrico.csv"
INPUT_OUTLIERS = "data/auditoria_vecinos_ranking_riesgo_actual.csv"
OUTPUT_DETALLE = "data/auditoria_outliers_temporales.csv"
OUTPUT_RESUMEN = "data/auditoria_outliers_temporales_resumen.csv"
