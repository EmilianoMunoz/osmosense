...
def run_api_checks(api_url: str, expected_source: str, timeout: float) -> None:
    ...
    latest = get_json(api_url, "/rankings/latest?limit=5", timeout)
    ...
    latest_geojson = get_json(api_url, "/rankings/latest/geojson", timeout)
    ...
    clientes = get_json(api_url, "/clientes", timeout)
    ...
    admin_clientes = get_json(api_url, "/admin/clientes?limit=5", timeout)
    ...
    admin_parcelas = get_json(api_url, "/admin/parcelas?limit=1", timeout)
    ...
    admin_parcela = get_json(api_url, f"/admin/parcelas/{parcela_id}", timeout)
    ...
    disponibles = get_json(api_url, "/admin/parcelas/disponibles?limit=1", timeout)
    ...
    admin_cliente_parcelas = get_json(api_url, f"/admin/clientes/{cliente_id}/parcelas", timeout)
    ...
    regional = get_json(api_url, "/regional/um/latest?limit=5", timeout)
    ...
    regional_geojson = get_json(api_url, "/regional/um/latest/geojson", timeout)
    ...
    um_parcelas = get_json(api_url, f"/regional/um/{um_id}/parcelas/latest/geojson", timeout)
