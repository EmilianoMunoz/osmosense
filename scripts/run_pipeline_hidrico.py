...
from scripts.generar_ranking_hidrico import generar_ranking


INPUT_TEMPORAL = "data/dataset_temporal_hidrico.csv"
MODEL_DIR = "models/hidrico_regresion"
RANKING_CONFIG = "models/ranking_hidrico_config.json"
PARCELAS_GEOJSON = "data/parcelas/san_rafael_vid_olivo_wgs84.geojson"
OUTPUT_SAMPLE = "data/parcelas/muestra_temporal_full_vid_olivo.geojson"
RANKINGS_DIR = "data/rankings"
STATE_DIR = "data/state"
LOGS_DIR = "data/logs"
AUDIT_HISTORY_DIR = "data/auditorias"
AUDIT_HISTORICAL_METRICS = "data/auditoria_metricas_historicas.csv"
AUDIT_VECINOS_DETALLE = "data/auditoria_vecinos_ranking_riesgo_actual.csv"
AUDIT_VECINOS_RESUMEN = "data/auditoria_vecinos_ranking_riesgo_actual_resumen.csv"
AUDIT_VECINOS_GEOJSON = "data/auditoria_vecinos_ranking_riesgo_actual.geojson"
AUDIT_TEMPORAL_DETALLE = "data/auditoria_outliers_temporales.csv"
AUDIT_TEMPORAL_RESUMEN = "data/auditoria_outliers_temporales_resumen.csv"
AUDIT_RUIDO_DETALLE = "data/auditoria_ruido_puntual_detalle.csv"
AUDIT_RUIDO_RESUMEN = "data/auditoria_ruido_puntual_resumen.csv"
AUDIT_RUIDO_GEOJSON = "data/auditoria_ruido_puntual_detalle.geojson"
ZONIFICACION_GEOJSON = "data/zonificacion/regional_dgi_san_rafael.geojson"
ZONIFICACION_OUT_DIR = "data/zonificacion"
...
def resolver_latest_valid_date(args: argparse.Namespace, log_path: Path) -> str:
    ...
    from app.services.images import obtener_imagenes_sentinel
