...
OUTPUT_DETALLE = "data/auditoria_vecinos_ranking.csv"
OUTPUT_RESUMEN = "data/auditoria_vecinos_ranking_resumen.csv"
OUTPUT_GEOJSON = "data/auditoria_vecinos_ranking.geojson"
