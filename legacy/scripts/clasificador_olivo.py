...
print("=== Clasificador: OLIVO vs RESTO ===\n")
...
# solo cultivos
df = df[df["cultivo"].isin(["vid", "frutales", "olivo"])].copy()
...
# TARGET BINARIO
# ================================
df[TARGET] = df["cultivo"].apply(lambda x: 1 if x == "olivo" else 0)
...
# métrica clave
recall_olivo = classification_report(
    y_test, y_pred, output_dict=True
)["1"]["recall"]

print(f"\nRecall OLIVO (clave): {recall_olivo:.3f}")
...
print("\nModelo guardado en models/clasificador_olivo.pkl")
print("\n=== Proceso completado ===")
